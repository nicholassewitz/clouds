...
..\..\Java\bin\java.exe -cp ..\..\dataloader-34.0-uber.jar;..\..\Java\bin\postgresql.jdbc4.jar -Dsalesforce.config.dir=%1 com.salesforce.dataloader.process.ProcessRunner %PROCESS_OPTION%
